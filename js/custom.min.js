!(function () {
  ...
  var e = {
    ...
    a = function () {
      var e = 0;
      jQuery(".bootstrap-animate").waypoint(
        function (t) {
          "down" !== t ||
            jQuery(this.element).hasClass("bootstrap-animated") ||
            (e++,
            jQuery(this.element).addClass("item-animate"),
            setTimeout(function () {
              jQuery("body .bootstrap-animate.item-animate").each(function (e) {
                var t = jQuery(this);
                setTimeout(
                  function () {
                    var e = t.data("animate-effect");
                    "fadeIn" === e
                      ? t.addClass("fadeIn bootstrap-animated")
                      : "fadeInLeft" === e
                      ? t.addClass("fadeInLeft bootstrap-animated")
                      : "fadeInRight" === e
                      ? t.addClass("fadeInRight bootstrap-animated")
                      : t.addClass("fadeInUp bootstrap-animated"),
    ...
    r = function (e) {
      for (
        var t = function (e) {
            for (
              var t, n, a, i, r = e.childNodes, o = r.length, s = [], u = 0;
              u < o;
              u++
            )
              1 === (t = r[u]).nodeType &&
                ((n = t.children[0]),
                console.log(t),
                (a = n.getAttribute("data-size").split("x")),
                (i = {
          ...
          a = function (e, n, a, i) {
            ...
            if (
              ...
              (r = {
                ...
                getThumbBoundsFn: function (e) {
                  ...
                  return { x: a.left, y: a.top + n, w: a.width };
                },
              }),
              i)
            )
            ...
            isNaN(r.index) ||
              (a && (r.showAnimationDuration = 0),
              new PhotoSwipe(s, PhotoSwipeUI_Default, o, r).init());
          },
        ...
        i[r].setAttribute("data-pswp-uid", r + 1),
          (i[r].onclick = function (e) {
    ...
    u = function () {
      jQuery("#time").timepicker(),
        jQuery("#date").datepicker({ format: "m/d/yyyy", autoclose: !0 });
    },
    l = function () {
      jQuery('.navbar-nav a:not([class="external"])').click(function (t) {
        ...
        jQuery(".navbar-nav");
        return (
          e.any() && jQuery(".navbar-toggle").click(),
          jQuery('[data-section="' + n + '"]').length &&
            jQuery("html, body").animate(
              {
                scrollTop:
                  jQuery('[data-section="' + n + '"]').offset().top - 55,
              },
              500,
              "easeInOutExpo"
            ),
  ...
  jQuery(function () {
    a(),
      i(),
      jQuery(".otl-gallery").length > 0 && r(".otl-gallery"),
      o(),
      s(),
      u(),
      l(),
