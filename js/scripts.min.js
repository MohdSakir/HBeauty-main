if (
  ((function (t, e) {
    ...
    function s(t) {
      var e = {};
      return (
        dt.each(t.match(Dt) || [], function (t, i) {
          e[i] = !0;
        }),
        e
      );
    ...
    function c(t, e, i, n) {
      if (At(t)) {
        ...
        if (
          ...
          return (
            u || (u = a ? (t[r] = et.pop() || dt.guid++) : r),
            l[u] || (l[u] = a ? {} : { toJSON: dt.noop }),
            ("object" != typeof e && "function" != typeof e) ||
              (n
                ? (l[u] = dt.extend(l[u], e))
                : (l[u].data = dt.extend(l[u].data, e))),
            (s = l[u]),
            n || (s.data || (s.data = {}), (s = s.data)),
            void 0 !== i && (s[dt.camelCase(e)] = i),
            "string" == typeof e
              ? null == (o = s[e]) && (o = s[dt.camelCase(e)])
              : (o = s),
            o
          );
      }
      ...
      if (At(t)) {
        ...
        if (r[a]) {
          if (e && (n = i ? r[a] : r[a].data)) {
            dt.isArray(e)
              ? (e = e.concat(dt.map(e, dt.camelCase)))
              : e in n
              ? (e = [e])
              : ((e = dt.camelCase(e)), (e = e in n ? [e] : e.split(" "))),
              (o = e.length);
            for (; o--; ) delete n[e[o]];
            if (i ? !u(n) : !dt.isEmptyObject(n)) return;
          }
          (i || (delete r[a].data, u(r[a]))) &&
            (s
              ? dt.cleanData([t], !0)
              : ct.deleteExpando || r != r.window
              ? delete r[a]
              : (r[a] = void 0));
        }
      }
    ...
    function f(t, e) {
      ...
      if (!s)
        for (s = [], i = t.childNodes || t; null != (n = i[o]); o++)
          !e || dt.nodeName(n, e) ? s.push(n) : dt.merge(s, f(n, e));
    ...
    function v(t, e, i, n, o) {
      for (
        var s, r, a, l, u, c, h, d = t.length, v = p(e), y = [], w = 0;
        d > w;
        w++
      )
        if ((r = t[w]) || 0 === r)
          if ("object" === dt.type(r)) dt.merge(y, r.nodeType ? [r] : r);
            ...
            for (
              l = l || v.appendChild(e.createElement("div")),
                u = (Ft.exec(r) || ["", ""])[1].toLowerCase(),
                h = qt[u] || qt._default,
                l.innerHTML = h[1] + dt.htmlPrefilter(r) + h[2],
                s = h[0];
              s--;
              ...
              l = l.lastChild;
            if (
              (!ct.leadingWhitespace &&
                Wt.test(r) &&
                y.push(e.createTextNode(Wt.exec(r)[0])),
              !ct.tbody)
            )
              for (
                s =
                ...
                dt.nodeName((c = r.childNodes[s]), "tbody") &&
                  !c.childNodes.length &&
                  r.removeChild(c);
            for (dt.merge(y, l.childNodes), l.textContent = ""; l.firstChild; )
              l.removeChild(l.firstChild);
            l = v.lastChild;
          } else y.push(e.createTextNode(r));
      for (
        l && v.removeChild(l),
          ct.appendChecked || dt.grep(f(y, "input"), g),
          w = 0;
        (r = y[w++]);
        ...
        if (n && dt.inArray(r, n) > -1) o && o.push(r);
          ...
          ((a = dt.contains(r.ownerDocument, r)),
          (l = f(v.appendChild(r), "script")),
          a && m(l),
          i)
        )
          for (s = 0; (r = l[s++]); ) jt.test(r.type || "") && i.push(r);
      return (l = null), v;
    }
    function y() {
      return !0;
    ...
    function S(t, e) {
      ...
      if (1 === e.nodeType) {
        if (
          ((i = e.nodeName.toLowerCase()), !ct.noCloneEvent && e[dt.expando])
        ) {
          o = dt._data(e);
    ...
    function D(t, e, i, n) {
      ...
      var o,
        ...
        p = e[0],
        m = dt.isFunction(p);
      if (m || (h > 1 && "string" == typeof p && !ct.checkClone && ee.test(p)))
        return t.each(function (o) {
          var s = t.eq(o);
          m && (e[0] = p.call(this, o, s.html())), D(s, e, i, n);
        });
      if (
        h &&
        ((u = v(e, t[0].ownerDocument, !1, t, n)),
        (o = u.firstChild),
        1 === u.childNodes.length && (u = o),
        o || n)
      ) {
        for (r = (a = dt.map(f(u, "script"), C)).length; h > c; c++)
          (s = u),
            c !== d &&
              ((s = dt.clone(s, !0, !0)), r && dt.merge(a, f(s, "script"))),
            i.call(t[c], s, c);
        if (r)
          for (
            l = a[a.length - 1].ownerDocument, dt.map(a, _), c = 0;
            r > c;
            c++
          )
            (s = a[c]),
              jt.test(s.type || "") &&
                !dt._data(s, "globalEval") &&
                dt.contains(l, s) &&
                (s.src
                  ? dt._evalUrl && dt._evalUrl(s.src)
                  : dt.globalEval(
    ...
    function E(t, e, i) {
      for (var n, o = e ? dt.filter(e, t) : t, s = 0; null != (n = o[s]); s++)
        i || 1 !== n.nodeType || dt.cleanData(f(n)),
          n.parentNode &&
            (i && dt.contains(n.ownerDocument, n) && m(f(n, "script")),
    ...
    function A(t) {
      ...
      return (
        i ||
          (("none" !== (i = I(t, e)) && i) ||
            ((se = (
              se || dt("<iframe frameborder='0' width='0' height='0'/>")
            ).appendTo(e.documentElement)),
            (e = (se[0].contentWindow || se[0].contentDocument)
              .document).write(),
            e.close(),
            (i = I(t, e)),
            se.detach()),
    ...
    function N(t, e) {
      for (var i, n, o, s = [], r = 0, a = t.length; a > r; r++)
        (n = t[r]).style &&
          ((s[r] = dt._data(n, "olddisplay")),
          (i = n.style.display),
          e
            ? (s[r] || "none" !== i || (n.style.display = ""),
              "" === n.style.display &&
                zt(n) &&
                (s[r] = dt._data(n, "olddisplay", A(n.nodeName))))
            : ((o = zt(n)),
              ((i && "none" !== i) || !o) &&
                dt._data(n, "olddisplay", o ? i : dt.css(n, "display"))));
      for (r = 0; a > r; r++)
        (n = t[r]).style &&
          ((e && "none" !== n.style.display && "" !== n.style.display) ||
            (n.style.display = e ? s[r] || "" : "none"));
      return t;
    }
    function L(t, e, i) {
      var n = ve.exec(e);
    ...
    function $(t, e, i, n, o) {
      for (
        ...
        "margin" === i && (r += dt.css(t, i + $t[s], !0, o)),
          n
            ? ("content" === i && (r -= dt.css(t, "padding" + $t[s], !0, o)),
              "margin" !== i &&
                (r -= dt.css(t, "border" + $t[s] + "Width", !0, o)))
            : ((r += dt.css(t, "padding" + $t[s], !0, o)),
              "padding" !== i &&
                (r += dt.css(t, "border" + $t[s] + "Width", !0, o)));
      return r;
    }
    function z(t, e, i) {
      ...
      if (0 >= o || null == o) {
        if (
          ((0 > (o = de(t, e, s)) || null == o) && (o = t.style[e]), le.test(o))
        )
          return o;
    ...
    function F(t, e) {
      ...
      for (e = e ? 1 : 0; 4 > o; o += 2 - e)
        (i = $t[o]), (n["margin" + i] = n["padding" + i] = t);
      return e && (n.opacity = n.width = t), n;
    }
    function j(t, e, i) {
      for (
        var n,
          o = (H.tweeners[e] || []).concat(H.tweeners["*"]),
          s = 0,
          r = o.length;
        r > s;
        s++
    ...
    function H(t, e, i) {
      var n,
        ...
        c = u.props;
      for (W(c, u.opts.specialEasing); r > s; s++)
        if ((n = H.prefilters[s].call(u, t, c, u.opts)))
          return (
            dt.isFunction(n.stop) &&
              (dt._queueHooks(u.elem, u.opts.queue).stop = dt.proxy(n.stop, n)),
            n
          );
      return (
        dt.map(c, j, u),
    ...
    (dt.fn = dt.prototype = {
      ...
      (dt.extend = dt.fn.extend = function () {
        ...
        for (
          "boolean" == typeof r && ((u = r), (r = arguments[a] || {}), a++),
            "object" == typeof r || dt.isFunction(r) || (r = {}),
            a === l && ((r = this), a--);
          l > a;
          a++
        )
          if (null != (o = arguments[a]))
            for (n in o)
              (t = r[n]),
                (i = o[n]),
                r !== i &&
                  (u && i && (dt.isPlainObject(i) || (e = dt.isArray(i)))
                    ? (e
                        ? ((e = !1), (s = t && dt.isArray(t) ? t : []))
                        : (s = t && dt.isPlainObject(t) ? t : {}),
                      (r[n] = dt.extend(u, s, i)))
                    : void 0 !== i && (r[n] = i));
        return r;
      }),
      ...
      "function" == typeof Symbol &&
        (dt.fn[Symbol.iterator] = et[Symbol.iterator]),
      dt.each(
    ...
    var vt = (function (t) {
      function e(t, e, i, n) {
        ...
        if (
          !n &&
          ((e ? e.ownerDocument || e : R) !== A && I(e), (e = e || A), M)
        ) {
          if (11 !== m && (h = mt.exec(t)))
            if ((o = h[1])) {
              if (9 === m) {
      ...
      function i() {
        function t(i, n) {
          return (
            e.push(i + " ") > b.cacheLength && delete t[e.shift()],
            (t[i + " "] = n)
          );
        }
        var e = [];
      ...
      function r(t, e) {
        var i = e && t,
          n =
            ...
            1 === t.nodeType &&
            1 === e.nodeType &&
            (~e.sourceIndex || B) - (~t.sourceIndex || B);
        if (n) return n;
      ...
      function f(t, e, i, n, o) {
        for (var s, r = [], a = 0, l = t.length, u = null != e; l > a; a++)
        ...
        return (
          ...
          n(function (n, r, a, l) {
            var u,
              ...
              w = i ? (s || (n ? t : g || o) ? [] : r) : y;
            if ((i && i(y, w, a, l), o))
              for (u = f(w, m), o(u, [], a, l), c = u.length; c--; )
                (h = u[c]) && (w[m[c]] = !(y[m[c]] = h));
            if (n) {
              if (s || t) {
                if (s) {
            ...
            } else (w = f(w === r ? w.splice(g, w.length) : w)), s ? s(null, r, w, l) : Z.apply(r, w);
          })
        );
      }
      function g(t) {
        ...
        var o = i.length > 0,
          ...
          r = function (n, r, a, l, u) {
            ...
            for (
              ...
              if (s && c) {
                for (
                  h = 0, r || c.ownerDocument === A || (I(c), (a = !M));
                  (d = t[h++]);
      ...
      (w = e.support = {}),
          ...
          return n !== A && 9 === n.nodeType && n.documentElement
            ? ((A = n),
              ...
              (i = A.defaultView) &&
                i.top !== i &&
                (i.addEventListener
                  ? i.addEventListener("unload", bt, !1)
                  : i.attachEvent && i.attachEvent("onunload", bt)),
                ...
                ? function (t, e) {
                    ...
                    return (
                      ...
                      (!w.sortDetached && e.compareDocumentPosition(t) === i)
                        ? t === A || (t.ownerDocument === R && z(R, t))
                          ? -1
                          : e === A || (e.ownerDocument === R && z(R, e))
                          ? 1
                          : D
                          ? K(D, t) - K(D, e)
                          : 0
        ...
        (e.attr = function (t, e) {
          ...
          var i = b.attrHandle[e.toLowerCase()],
            n =
              i && Y.call(b.attrHandle, e.toLowerCase()) ? i(t, e, !M) : void 0;
          return void 0 !== n
            ? n
            : w.attributes || !M
            ? t.getAttribute(e)
        ...
        (C = e.tokenize = function (t, i) {
          ...
          for (a = t, l = [], u = b.preFilter; a; ) {
            (n && !(o = rt.exec(a))) ||
              ...
              (o = at.exec(a)) &&
                ((n = o.shift()),
                s.push({ value: n, type: o[0].replace(st, " ") }),
                (a = a.slice(n.length)));
            for (r in b.filter)
              !(o = ht[r].exec(a)) ||
                (u[r] && !(o = u[r](o))) ||
            ...
            for (
              ...
              if (
                ...
                (n = u(
                  ...
                  (gt.test(s[0].type) && l(e.parentNode)) || e
                ))
              ) {
                if ((s.splice(o, 1), !(t = n.length && c(s))))
    ...
    (dt.filter = function (t, e, i) {
      ...
      dt.fn.extend({
        find: function (t) {
          ...
          return (
            (i = this.pushStack(o > 1 ? dt.unique(i) : i)),
        ...
        if (n[1]) {
          if (
            ...
            dt.merge(
              ...
              dt.parseHTML(
                n[1],
                e && e.nodeType ? e.ownerDocument || e : it,
                !0
              )
            ),
    ...
    dt.fn.extend({
      ...
      closest: function (t, e) {
        for (
          var i,
            ...
            s = [],
            r =
              bt.test(t) || "string" != typeof t ? dt(t, e || this.context) : 0;
          o > n;
          n++
        )
      ...
      index: function (t) {
        return t
          ? "string" == typeof t
            ? dt.inArray(this[0], dt(t))
            : dt.inArray(t.jquery ? t[0] : t, this)
          ...
          return (
            ...
            dt.each(e, function (t, s) {
              ...
              (n[s[1]] = r.add),
                ...
                (o[s[0]] = function () {
                  return (
                    o[s[0] + "With"](this === o ? n : this, arguments), this
                  );
                }),
      ...
      dt.extend({
        ...
        ready: function (t) {
          (!0 === t ? --dt.readyWait : dt.isReady) ||
            ((dt.isReady = !0),
            (!0 !== t && --dt.readyWait > 0) ||
              (Et.resolveWith(it, [dt]),
              dt.fn.triggerHandler &&
                (dt(it).triggerHandler("ready"), dt(it).off("ready"))));
        },
      }),
    ...
    (ct.ownFirst = "0" === It),
      ...
      dt(function () {
        var t, e, i, n;
        (i = it.getElementsByTagName("body")[0]) &&
          i.style &&
    ...
    dt.extend({
      ...
      hasData: function (t) {
        return (
          !!(t = t.nodeType ? dt.cache[t[dt.expando]] : t[dt.expando]) && !u(t)
        );
      },
      data: function (t, e, i) {
        return c(t, e, i);
        ...
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (
              this.length &&
              ((o = dt.data(s)),
              1 === s.nodeType && !dt._data(s, "parsedAttrs"))
            ) {
              for (i = r.length; i--; )
                r[i] &&
                  0 === (n = r[i].name).indexOf("data-") &&
                  ((n = dt.camelCase(n.slice(5))), l(s, n, o[n]));
      ...
      (function () {
        ...
        ct.shrinkWrapBlocks = function () {
          ...
          t = !1;
          var e, i, n;
          return (i = it.getElementsByTagName("body")[0]) && i.style
            ? ((e = it.createElement("div")),
              (n = it.createElement("div")),
              (n.style.cssText =
                "position:absolute;border:0;width:0;height:0;top:0;left:-9999px"),
    ...
    !(function () {
      ...
      for (e in { submit: !0, change: !0, focusin: !0 })
        (i = "on" + e),
          (ct[e] = i in t) ||
            (n.setAttribute(i, "t"), (ct[e] = !1 === n.attributes[i].expando));
      n = null;
    })();
    ...
    (dt.event = {
            ...
            i.handler && ((l = i), (i = l.handler), (o = l.selector)),
              ...
              (c = g.handle) ||
                ((c = g.handle = function (t) {
                  return void 0 === dt || (t && dt.event.triggered === t.type)
                    ? void 0
                    : dt.event.dispatch.apply(c.elem, arguments);
                }),
                (c.elem = t)),
              a = (e = (e || "").match(Dt) || [""]).length;
            a--;
            ...
            (s = Zt.exec(e[a]) || []),
              ...
              p &&
                ...
                (d = r[p]) ||
                  ((d = r[p] = []),
                  (d.delegateCount = 0),
                  (u.setup && !1 !== u.setup.call(t, n, f, c)) ||
                    (t.addEventListener
            ...
            if (
              ...
              for (
                h = dt.event.special[p] || {},
                  d = c[(p = (n ? h.delegateType : h.bindType) || p)] || [],
                  a =
                    a[2] &&
                    new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                  l = s = d.length;
      ...
      trigger: function (e, i, n, o) {
        ...
        if (
          ...
          if (!o && !u.noBubble && !dt.isWindow(n)) {
            for (
              l = u.delegateType || p, Xt.test(l + p) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              d.push(a), (c = a);
          ...
          for (h = 0; (a = d[h++]) && !e.isPropagationStopped(); )
            (e.type = h > 1 ? l : u.bindType || p),
              (s =
                (dt._data(a, "events") || {})[e.type] &&
                dt._data(a, "handle")) && s.apply(a, i),
              (s = r && a[r]) &&
                s.apply &&
                At(a) &&
                ((e.result = s.apply(a, i)),
                !1 === e.result && e.preventDefault());
          if (
            ((e.type = p),
            !o &&
              !e.isDefaultPrevented() &&
              (!u._default || !1 === u._default.apply(d.pop(), i)) &&
              At(n) &&
              r &&
              n[p] &&
              !dt.isWindow(n))
      ...
      dispatch: function (t) {
        ...
        if (
          ...
          for (
            r = dt.event.handlers.call(this, t, l), e = 0;
            (o = r[e++]) && !t.isPropagationStopped();

          )
            for (
              t.currentTarget = o.elem, i = 0;
              (s = o.handlers[i++]) && !t.isImmediatePropagationStopped();
        ...
        (dt.event.special.submit = {
            ...
            return (
              ...
              void dt.event.add(
                ...
                function (t) {
                  var e = t.target,
                    i =
                      dt.nodeName(e, "input") || dt.nodeName(e, "button")
                        ? dt.prop(e, "form")
                        : void 0;
                  i &&
                    !dt._data(i, "submit") &&
                    (dt.event.add(i, "submit._submit", function (t) {
                      t._submitBubble = !0;
                    }),
                    dt._data(i, "submit", !0));
                }
          ...
          postDispatch: function (t) {
            t._submitBubble &&
              ...
              this.parentNode &&
                !t.isTrigger &&
                dt.event.simulate("submit", this.parentNode, t));
          },
          teardown: function () {
            return (
              !dt.nodeName(this, "form") &&
              void dt.event.remove(this, "._submit")
            );
          },
        }),
      ct.change ||
        (dt.event.special.change = {
          setup: function () {
            return Yt.test(this.nodeName)
              ? (("checkbox" !== this.type && "radio" !== this.type) ||
                ...
                !1)
              : void dt.event.add(this, "beforeactivate._change", function (t) {
                  var e = t.target;
                  Yt.test(e.nodeName) &&
                    !dt._data(e, "change") &&
                    (dt.event.add(e, "change._change", function (t) {
                      !this.parentNode ||
                        t.isSimulated ||
                        t.isTrigger ||
                        dt.event.simulate("change", this.parentNode, t);
                    }),
                    dt._data(e, "change", !0));
                });
          },
          ...
          teardown: function () {
            return dt.event.remove(this, "._change"), !Yt.test(this.nodeName);
          },
        }),
      ct.focusin ||
          ...
          dt.event.special[e] = {
            setup: function () {
              var n = this.ownerDocument || this,
                o = dt._data(n, e);
              o || n.addEventListener(t, i, !0), dt._data(n, e, (o || 0) + 1);
            },
            teardown: function () {
              var n = this.ownerDocument || this,
                o = dt._data(n, e) - 1;
              o
                ? dt._data(n, e, o)
                : (n.removeEventListener(t, i, !0), dt._removeData(n, e));
            },
          };
        }),
      dt.fn.extend({
    ...
    dt.extend({
      ...
      clone: function (t, e, i) {
        ...
        if (
          (ct.html5Clone || dt.isXMLDoc(t) || !Kt.test("<" + t.nodeName + ">")
            ? (s = t.cloneNode(!0))
            : ((oe.innerHTML = t.outerHTML),
              oe.removeChild((s = oe.firstChild))),
          !(
            (ct.noCloneEvent && ct.noCloneChecked) ||
            (1 !== t.nodeType && 11 !== t.nodeType) ||
            dt.isXMLDoc(t)
          ))
        )
          for (n = f(s), a = f(t), r = 0; null != (o = a[r]); ++r)
            n[r] && S(o, n[r]);
        if (e)
          if (i)
            for (a = a || f(t), n = n || f(s), r = 0; null != (o = a[r]); r++)
              k(o, n[r]);
          else k(t, s);
        return (
          (n = f(s, "script")).length > 0 && m(n, !l && f(t, "script")),
          (n = a = o = null),
          s
        );
      },
      cleanData: function (t, e) {
        for (
          ...
          if ((e || At(i)) && ((o = i[a]), (s = o && l[o]))) {
            if (s.events)
              for (n in s.events)
                c[n] ? dt.event.remove(i, n) : dt.removeEvent(i, n, s.handle);
            l[o] &&
              (delete l[o],
      ...
      dt.fn.extend({
        ...
        empty: function () {
          for (var t, e = 0; null != (t = this[e]); e++) {
            for (1 === t.nodeType && dt.cleanData(f(t, !1)); t.firstChild; )
          ...
          return Pt(
            ...
            function (t) {
              var e = this[0] || {},
                ...
                n = this.length;
              if (void 0 === t)
                return 1 === e.nodeType ? e.innerHTML.replace(Gt, "") : void 0;
              if (
                "string" == typeof t &&
                !te.test(t) &&
                (ct.htmlSerialize || !Kt.test(t)) &&
                (ct.leadingWhitespace || !Wt.test(t)) &&
                !qt[(Ft.exec(t) || ["", ""])[1].toLowerCase()]
              ) {
                t = dt.htmlPrefilter(t);
                try {
                  for (; n > i; i++)
                    1 === (e = this[i] || {}).nodeType &&
                      (dt.cleanData(f(e, !1)), (e.innerHTML = t));
                  e = 0;
                } catch (t) {}
              }
        ...
        replaceWith: function () {
          ...
          return D(
            ...
            function (e) {
              ...
              dt.inArray(this, t) < 0 &&
                (dt.cleanData(f(this)), i && i.replaceChild(e, this));
            },
            t
          );
        },
      ...
      dt.each(
        ...
        function (t, e) {
          dt.fn[t] = function (t) {
            for (var i, n = 0, o = [], s = dt(t), r = s.length - 1; r >= n; n++)
    ...
    !(function () {
      ...
      u.style &&
        ...
        (ct.opacity = "0.5" === u.style.opacity),
        (ct.cssFloat = !!u.style.cssFloat),
        ...
        (de = function (t, e, i) {
          ...
          return (
            ...
            le.test(r) &&
              ...
              ((n = a.left),
              (o = t.runtimeStyle),
              (s = o && o.left) && (o.left = t.currentStyle.left),
    ...
    dt.extend({
      ...
      dt.each(["height", "width"], function (t, e) {
        dt.cssHooks[e] = {
          get: function (t, i, n) {
            return i
              ? ge.test(dt.css(t, "display")) && 0 === t.offsetWidth
                ? ue(t, ye, function () {
                    return z(t, e, n);
                  })
                : z(t, e, n)
      ...
      ct.opacity ||
        (dt.cssHooks.opacity = {
          ...
          set: function (t, e) {
            ...
            (i.zoom = 1),
              ((e >= 1 || "" === e) &&
                "" === dt.trim(s.replace(fe, "")) &&
                i.removeAttribute &&
                (i.removeAttribute("filter"), "" === e || (n && !n.filter))) ||
                (i.filter = fe.test(s) ? s.replace(fe, o) : s + " " + o);
          },
        }),
      (dt.cssHooks.marginRight = O(ct.reliableMarginRight, function (t, e) {
        return e
          ? ue(t, { display: "inline-block" }, de, [t, "marginRight"])
          : void 0;
      })),
      (dt.cssHooks.marginLeft = O(ct.reliableMarginLeft, function (t, e) {
        return e
          ? (parseFloat(de(t, "marginLeft")) ||
              (dt.contains(t.ownerDocument, t)
                ? t.getBoundingClientRect().left -
                  ue(t, { marginLeft: 0 }, function () {
          ...
          return Pt(
            ...
            function (t, e, i) {
              var n,
                ...
                r = 0;
              if (dt.isArray(e)) {
                for (n = he(t), o = e.length; o > r; r++)
                  s[e[r]] = dt.css(t, e[r], !1, n);
                return s;
              }
    ...
    (dt.Animation = dt.extend(H, {
      tweeners: {
        "*": [
          function (t, e) {
            ...
            return d(i.elem, t, Lt.exec(e), i), i;
          },
        ],
      },
      ...
      prefilters: [
        function (t, e, i) {
          var n,
            ...
            f = dt._data(t, "fxshow");
          i.queue ||
            (null == (a = dt._queueHooks(t, "fx")).unqueued &&
              ((a.unqueued = 0),
              (l = a.empty.fire),
            ...
            1 === t.nodeType &&
              ...
              "inline" ===
                ("none" === (u = dt.css(t, "display"))
                  ? dt._data(t, "olddisplay") || A(t.nodeName)
                  : u) &&
                "none" === dt.css(t, "float") &&
                (ct.inlineBlockNeedsLayout && "inline" !== A(t.nodeName)
                  ? (d.zoom = 1)
          ...
          if (dt.isEmptyObject(h))
            "inline" === ("none" === u ? A(t.nodeName) : u) && (d.display = u);
          else {
            f
      ...
      (dt.speed = function (t, e, i) {
        ...
        return (
          (n.duration = dt.fx.off
            ? 0
            : "number" == typeof n.duration
            ? n.duration
            : n.duration in dt.fx.speeds
            ? dt.fx.speeds[n.duration]
      ...
      (function () {
        ...
        (i = it.createElement("div")).setAttribute("className", "t"),
          (i.innerHTML =
            "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
    ...
    dt.fn.extend({
        ...
        return arguments.length
          ? ((n = dt.isFunction(t)),
            this.each(function (i) {
              var o;
              1 === this.nodeType &&
                (null == (o = n ? t.call(this, i, dt(this).val()) : t)
                  ? (o = "")
                  : "number" == typeof o
                  ? (o += "")
                  : dt.isArray(o) &&
                    (o = dt.map(o, function (t) {
                      return null == t ? "" : t + "";
                    })),
                ((e =
          ...
          : o
          ? (e =
              dt.valHooks[o.type] || dt.valHooks[o.nodeName.toLowerCase()]) &&
            "get" in e &&
      ...
      dt.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (
                var i, n, o = t.options, s = dt.makeArray(e), r = o.length;
                r--;

              )
                if (((n = o[r]), dt.inArray(dt.valHooks.option.get(n), s) > -1))
                  try {
                    n.selected = i = !0;
                  } catch (t) {
                    n.scrollHeight;
      ...
      dt.each(["radio", "checkbox"], function () {
        (dt.valHooks[this] = {
          set: function (t, e) {
            return dt.isArray(e)
              ? (t.checked = dt.inArray(dt(t).val(), e) > -1)
              : void 0;
          },
        }),
          ct.checkOn ||
      ...
      dt.extend({
          ...
          if (3 !== s && 8 !== s && 2 !== s)
            return void 0 === t.getAttribute
              ...
              : ((1 === s && dt.isXMLDoc(t)) ||
                  ((e = e.toLowerCase()),
                  (o =
                    dt.attrHooks[e] || (dt.expr.match.bool.test(e) ? Ie : Ee))),
                void 0 !== i
                  ? null === i
        ...
        removeAttr: function (t, e) {
          ...
          if (s && 1 === t.nodeType)
            for (; (i = s[o++]); )
              (n = dt.propFix[i] || i),
                dt.expr.match.bool.test(i)
                  ? (Ne && Me) || !Oe.test(i)
                    ? (t[n] = !1)
                    : (t[dt.camelCase("default-" + i)] = t[n] = !1)
                  : dt.attr(t, i, ""),
        ...
        set: function (t, e, i) {
          return (
            !1 === e
              ? dt.removeAttr(t, i)
              : (Ne && Me) || !Oe.test(i)
              ? t.setAttribute((!Me && dt.propFix[i]) || i, i)
              : (t[dt.camelCase("default-" + i)] = t[i] = !0),
            i
          );
        },
      }),
      ...
      dt.extend({
        prop: function (t, e, i) {
          ...
          if (3 !== s && 8 !== s && 2 !== s)
            return (
              (1 === s && dt.isXMLDoc(t)) ||
                ((e = dt.propFix[e] || e), (o = dt.propHooks[e])),
              void 0 !== i
                ? o && "set" in o && void 0 !== (n = o.set(t, i, e))
                  ? n
                  : (t[e] = i)
        ...
        propHooks: {
          tabIndex: {
            get: function (t) {
              ...
              return e
                ? parseInt(e, 10)
                : Le.test(t.nodeName) || ($e.test(t.nodeName) && t.href)
                ? 0
                : -1;
            },
          },
      ...
      toggleClass: function (t, e) {
        ...
        return "boolean" == typeof e && "string" === i
          ...
          : this.each(function () {
              var e, n, o, s;
              if ("string" === i)
                for (n = 0, o = dt(this), s = t.match(Dt) || []; (e = s[n++]); )
                  o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
              else
                (void 0 !== t && "boolean" !== i) ||
                  ((e = q(this)) && dt._data(this, "__className__", e),
                  dt.attr(
                    this,
                    "class",
                    e || !1 === t ? "" : dt._data(this, "__className__") || ""
                  ));
            });
      },
      hasClass: function (t) {
    ...
    dt.extend({
      ...
      ajax: function (e, i) {
            ...
            s
              ? (d.ifModified &&
                  ((x = T.getResponseHeader("Last-Modified")) &&
                    (dt.lastModified[r] = x),
                  (x = T.getResponseHeader("etag")) && (dt.etag[r] = x)),
                204 === e || "HEAD" === d.type
                  ? (C = "nocontent")
                  : 304 === e
                  ? (C = "notmodified")
                  : ((C = w.state), (h = w.data), (y = w.error), (s = !y)))
              : ((y = C), (!e && C) || ((C = "error"), 0 > e && (e = 0))),
            (T.status = e),
            (T.statusText = (i || C) + ""),
            s ? m.resolveWith(p, [h, C, T]) : m.rejectWith(p, [T, C, y]),
            T.statusCode(v),
            (v = void 0),
            u && f.trigger(s ? "ajaxSuccess" : "ajaxError", [T, d, s ? h : y]),
            g.fireWith(p, [T, C]),
            u &&
        ...
        (u = dt.event && d.global) &&
          0 == dt.active++ &&
          dt.event.trigger("ajaxStart"),
          (d.type = d.type.toUpperCase()),
          (d.hasContent = !Be.test(d.type)),
          (r = d.url),
          d.hasContent ||
            (d.data &&
              ((r = d.url += (Fe.test(r) ? "&" : "?") + d.data), delete d.data),
            !1 === d.cache &&
              (d.url = He.test(r)
                ? r.replace(He, "$1_=" + Re++)
                : r + (Fe.test(r) ? "&" : "?") + "_=" + Re++)),
          d.ifModified &&
            (dt.lastModified[r] &&
              T.setRequestHeader("If-Modified-Since", dt.lastModified[r]),
            dt.etag[r] && T.setRequestHeader("If-None-Match", dt.etag[r])),
        ...
        if (d.beforeSend && (!1 === d.beforeSend.call(p, T, d) || 2 === b))
          return T.abort();
        x = "abort";
        for (s in { success: 1, error: 1, complete: 1 }) T[s](d[s]);
        if ((c = B(Xe, d, i, T))) {
          if (((T.readyState = 1), u && f.trigger("ajaxSend", [T, d]), 2 === b))
            return T;
          d.async &&
            d.timeout > 0 &&
      ...
      dt.each(["get", "post"], function (t, e) {
        dt[e] = function (t, i, n, o) {
          return (
            dt.isFunction(i) && ((o = o || n), (n = i), (i = void 0)),
            dt.ajax(
              dt.extend(
      ...
      (dt.expr.filters.hidden = function (t) {
        return ct.reliableHiddenOffsets()
          ? t.offsetWidth <= 0 &&
              t.offsetHeight <= 0 &&
    ...
    (dt.param = function (t, e) {
      ...
      if (
        (void 0 === e && (e = dt.ajaxSettings && dt.ajaxSettings.traditional),
    ...
    t.attachEvent &&
      ...
      dt.ajaxTransport("script", function (t) {
        if (t.crossDomain) {
          var e,
            i = it.head || dt("head")[0] || it.documentElement;
          return {
            send: function (n, o) {
    ...
    dt.ajaxSetup({
      ...
      dt.ajaxPrefilter("json jsonp", function (e, i, n) {
        ...
        return a || "jsonp" === e.dataTypes[0]
          ? ((o = e.jsonpCallback = dt.isFunction(e.jsonpCallback)
              ? e.jsonpCallback()
              : e.jsonpCallback),
            a
              ? (e[a] = e[a].replace(li, "$1" + o))
              : !1 !== e.jsonp &&
    ...
    (dt.fn.load = function (t, e, i) {
      ...
      var n,
        ...
        a = t.indexOf(" ");
      return (
        a > -1 && ((n = dt.trim(t.slice(a, t.length))), (t = t.slice(0, a))),
        dt.isFunction(e)
          ? ((i = e), (e = void 0))
      ...
      dt.each(["top", "left"], function (t, e) {
        dt.cssHooks[e] = O(ct.pixelPosition, function (t, i) {
          return i
            ? ((i = de(t, e)), le.test(i) ? dt(t).position()[e] + "px" : i)
            : void 0;
        });
      }),
    ...
    return (
      (dt.noConflict = function (e) {
        return (
          t.$ === dt && (t.$ = hi), e && t.jQuery === dt && (t.jQuery = ci), dt
        );
      }),
      e || (t.jQuery = t.$ = dt),
      dt
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (t, e, i, n, o) {
      ...
      return (
        a * Math.pow(2, -10 * e) * Math.sin(((e * o - s) * (2 * Math.PI)) / r) +
        n +
        i
      );
    },
    ...
    easeInBack: function (t, e, i, n, o, s) {
      return (
        void 0 == s && (s = 1.70158), n * (e /= o) * e * ((s + 1) * e - s) + i
      );
    },
            ...
            this.$element.find("[data-stellar-ratio]").each(function () {
              ...
              e.options.showElement(d),
                ...
                e.particles.push({
                  ...
                  parentOffsetTop: f,
                  stellarRatio:
                    d.data("stellar-ratio") !== n ? d.data("stellar-ratio") : 1,
          ...
          this.options.parallaxBackgrounds &&
            ...
            e.each(function () {
              ...
              f.data("stellar-backgroundStartingLeft")
                ...
                : (f.data("stellar-backgroundStartingLeft", m[0]),
                ...
                i.backgrounds.push({
                  ...
                  parentOffsetTop: v,
                  stellarRatio:
                    f.data("stellar-background-ratio") === n
                      ? 1
        ...
        return e === n || "object" == typeof e
          ? this.each(function () {
              t.data(this, "plugin_" + s) ||
                t.data(this, "plugin_" + s, new o(this, e));
            })
      ...
      t.data(i, "flexslider", o),
            ...
            setupPaging: function () {
              ...
              if (
                ...
                for (var a = 0; a < o.pagingCount; a++) {
                  if (
                    (void 0 === (i = o.slides.eq(a)).attr("data-thumb-alt") &&
              ...
              o.controlsContainer
                ...
                g.controlNav.set(),
                g.controlNav.active(),
                o.controlNavScaffold.delegate("a, img", u, function (e) {
          ...
          pausePlay: {
            setup: function () {
              ...
              o.controlsContainer
                ...
                : (o.append(e), (o.pausePlay = t("." + r + "pauseplay a", o))),
                  ...
                  function (t) {
                    ...
                    if (e) {
                      ...
                      return (
                        ...
                        (r = w),
                        (g = h
                          ? Math.abs(w) < Math.abs(-o)
                          : Math.abs(w) < Math.abs(-a)),
                          ...
                          : void (
                              ...
                              !f &&
                                ...
                                (e.vars.animationLoop ||
                                  (r =
                                    w /
                                    ((0 === e.currentSlide && 0 > w) ||
                                    (e.currentSlide === e.last && w > 0)
                                      ? Math.abs(w) / s + 2
                                      : 1)),
                                e.setProps(n + r, "setTouch")))
                            )
                      );
                    }
                  },
                  ...
                  function (i) {
                    ...
                    if (o) {
                      if (
                        ...
                        o.canAdvance(u) &&
                        ((Number(new Date()) - l < 550 && Math.abs(a) > 50) ||
                          Math.abs(a) > s / 2)
                      ...
                      (t = null), (e = null), (r = null), (n = null), (w = 0);
                    }
                  },
                  !1
                ))
              : ((u = function (r) {
                ...
                (c = function (i) {
                  (v = i.touches[0].pageX),
                    ...
                    (r = h ? t - y : t - v);
                  (!(g = h
                    ? Math.abs(r) < Math.abs(v - e)
                    : Math.abs(r) < Math.abs(y - e)) ||
                    ...
                    !f &&
                      ...
                      (o.vars.animationLoop ||
                        (r /=
                          (0 === o.currentSlide && 0 > r) ||
                          (o.currentSlide === o.last && r > 0)
                            ? Math.abs(r) / s + 2
                            : 1),
                      o.setProps(n + r, "setTouch")));
                }),
                (m = function (a) {
                  if (
                    (i.removeEventListener("touchmove", c, !1),
                    o.animatingTo === o.currentSlide && !g && null !== r)
                  ) {
                    var u = d ? -r : r,
                      h = u > 0 ? o.getTarget("next") : o.getTarget("prev");
                    o.canAdvance(h) &&
                    ((Number(new Date()) - l < 550 && Math.abs(u) > 50) ||
                      Math.abs(u) > s / 2)
                      ? o.flexAnimate(h, o.vars.pauseOnAction)
                      : f ||
          ...
          if (
            ...
            if (
              ...
              var c,
                v,
                y,
                w = h ? o.slides.filter(":first").height() : o.computedW;
              p
                ? ((c = o.vars.itemMargin),
                  (y = (o.itemW + c) * o.move * o.animatingTo),
                  (v = y > o.limit && 1 !== o.visible ? o.limit : y))
                : (v =
                    0 === o.currentSlide &&
                    e === o.count - 1 &&
                    o.vars.animationLoop &&
        ...
        (o.setup = function (e) {
          if (f)
            ...
            var i, n;
            "init" === e &&
              ((o.viewport = t('<div class="' + r + 'viewport"></div>')
  ...
  (function (t, e) {
    ...
    function o(o) {
      if (
        ...
        for (
          var c = (u.isBorderBox = "border-box" == r.boxSizing), h = 0;
          h < l;
          h++
        ) {
          var d = a[h],
  ...
  (function (t, e) {
    ...
    n.extend(p, e.prototype),
      ...
      (p.updateStagger = function () {
        ...
        {
          if (null !== t && void 0 !== t)
            return (this.stagger = a(t)), this.stagger;
          this.stagger = 0;
        }
      }),
  ...
  (function (t) {
    ...
    function i(e) {
      if (
        (e.minTime && (e.minTime = w(e.minTime)),
        e.maxTime && (e.maxTime = w(e.maxTime)),
        e.durationTime &&
          "function" != typeof e.durationTime &&
          (e.durationTime = w(e.durationTime)),
        "now" == e.scrollDefault)
      )
      ...
      if (
        ...
        for (var n in e.disableTimeRanges)
          e.disableTimeRanges[n] = [
            w(e.disableTimeRanges[n][0]),
            w(e.disableTimeRanges[n][1]),
          ];
        e.disableTimeRanges = e.disableTimeRanges.sort(function (t, e) {
          return t[0] - e[0];
        });
        for (n = e.disableTimeRanges.length - 1; n > 0; n--)
          e.disableTimeRanges[n][0] <= e.disableTimeRanges[n - 1][1] &&
            ((e.disableTimeRanges[n - 1] = [
              Math.min(
                e.disableTimeRanges[n][0],
                e.disableTimeRanges[n - 1][0]
              ),
              Math.max(
                e.disableTimeRanges[n][1],
                e.disableTimeRanges[n - 1][1]
              ),
            ]),
    ...
    function n(e) {
      ...
      if (
        (n && n.length && (n.remove(), e.data("timepicker-list", !1)),
        i.useSelect)
      )
        var r = (n = t("<select />", { class: "ui-timepicker-select" }));
      else
        (n = t("<ul />", { class: "ui-timepicker-list" })),
          (r = t("<div />", { class: "ui-timepicker-wrapper", tabindex: -1 }))
            .css({ display: "none", position: "absolute" })
            .append(n);
      if (i.noneOption)
        if (
          (!0 === i.noneOption &&
            (i.noneOption = i.useSelect ? "Time..." : "None"),
          t.isArray(i.noneOption))
        ) {
      ...
      i.className && r.addClass(i.className),
        (null === i.minTime && null === i.durationTime) ||
          !i.showDuration ||
          ("function" == typeof i.step || i.step,
          r.addClass("ui-timepicker-with-duration"),
          r.addClass("ui-timepicker-step-" + i.step));
      var h = i.minTime;
      "function" == typeof i.durationTime
        ? (h = w(i.durationTime()))
        : null !== i.durationTime && (h = i.durationTime);
      var p = null !== i.minTime ? i.minTime : 0,
        f = null !== i.maxTime ? i.maxTime : p + x - 1;
      p > f && (f += x),
        f === x - 1 &&
          "string" === t.type(i.timeFormat) &&
          i.show2400 &&
          (f = x);
      ...
      for (var l = p, S = 0; f >= l; S++, l += 60 * k(S)) {
        var D = l,
          E = y(D, i);
        if (i.useSelect) (I = t("<option />", { value: E })).text(E);
        else {
          var I = t("<li />");
        ...
        if ((null !== i.minTime || null !== i.durationTime) && i.showDuration) {
          ...
          if (i.useSelect) I.text(I.text() + " (" + A + ")");
            ...
            var O = t("<span />", { class: "ui-timepicker-duration" });
            O.text(" (" + A + ")"), I.append(O);
          }
        }
        C > T &&
          ...
          m[T] &&
            ...
            (i.useSelect
              ? I.prop("disabled", !0)
              : I.addClass("ui-timepicker-disabled"))),
          n.append(I);
      }
      if (
        (r.data("timepicker-input", e),
        e.data("timepicker-list", r),
        i.useSelect)
      )
        e.val() && n.val(s(w(e.val()), i)),
          n.on("focus", function () {
        ...
        "string" == typeof M
          ...
          M.append(r),
          u(e, n),
          n.on("mousedown click", "li", function (i) {
            e.off("focus.timepicker"),
              ...
              g(e) &&
                ...
                n.on("mouseup.timepicker click.timepicker", "li", function (t) {
                  n.off("mouseup.timepicker click.timepicker"), r.hide();
                }));
          });
      }
    }
    function o(e, i) {
      ...
      return (
        "object" == typeof e
          ? ((n = e.label), (o = e.className), (s = e.value))
          : "string" == typeof e
          ? (n = e)
          : t.error("Invalid noneOption value"),
        i
          ? t("<option />", { value: s, class: o, text: n })
          : t("<li />", { class: o, text: n }).data("time", String(s))
      );
    }
    function s(t, e) {
    ...
    function l(e, i, n) {
      ...
      return (
        i.find("li").each(function (e, i) {
          var o = t(i);
          if ("number" == typeof o.data("time"))
            return o.data("time") == n ? ((s = o), !1) : void 0;
        }),
        s
      );
    }
    function u(t, e) {
      ...
      if (null !== n) {
        var o = l(t, e, n);
        if (o) {
          var s = o.offset().top - e.offset().top;
          (s + o.outerHeight() > e.outerHeight() || 0 > s) &&
            e.scrollTop(e.scrollTop() + o.position().top - o.outerHeight()),
            (i.forceRoundTime || o.data("time") === n) &&
              o.addClass("ui-timepicker-selected");
        }
      }
    }
    function c(e, i) {
      if ("timepicker" != i) {
        ...
        if (!n.is(":focus") || (e && "change" == e.type)) {
          ...
          if (
            (null !== o.minTime &&
              null !== o.maxTime &&
              (s < o.minTime || s > o.maxTime) &&
              (r = !0),
            t.each(o.disableTimeRanges, function () {
          ...
          var l = y(s, o);
          r
            ? (d(n, l, "error") || (e && "change" == e.type)) &&
              n.trigger("timeRangeError")
            : d(n, l, i);
        }
      }
    }
    ...
    function d(t, e, i) {
      if (t.is("input")) {
        ...
        n.useSelect &&
          "select" != i &&
          "initial" != i &&
          t.data("timepicker-list").val(s(w(e), n));
      }
      return t.data("ui-timepicker-value") != e
        ? (t.data("ui-timepicker-value", e),
          "select" == i
            ? t
                .trigger("selectTime")
                .trigger("changeTime")
                .trigger("change", "timepicker")
            : -1 == ["error", "initial"].indexOf(i) && t.trigger("changeTime"),
          !0)
        : (t.trigger("selectTime"), !1);
    }
    function p(t) {
      switch (t.keyCode) {
        case 13:
    ...
    function f(i) {
      ...
      switch (i.keyCode) {
        case 13:
          return (
            g(n) && (c.call(n.get(0), { type: "change" }), _.hide.apply(this)),
            i.preventDefault(),
            !1
          );
        case 38:
            ...
            s.length
              ? s.is(":first-child") ||
                ...
                s.prev().position().top < s.outerHeight() &&
                  o.scrollTop(o.scrollTop() - s.outerHeight()))
        ...
        case 40:
          return (
            0 === (s = o.find(".ui-timepicker-selected")).length
              ? (o.find("li").each(function (e, i) {
                  return t(i).position().top > 0 ? ((s = t(i)), !1) : void 0;
                }),
                s.addClass("ui-timepicker-selected"))
        ...
        case 27:
          o.find("li").removeClass("ui-timepicker-selected"), _.hide();
          break;
        case 9:
          _.hide();
          break;
    ...
    function g(t) {
      ...
      return (
        !n.hasClass("ui-timepicker-disabled") &&
        (n.length && (i = n.data("time")),
        null !== i &&
          ("string" != typeof i && (i = y(i, e)), d(t, i, "select")),
        !0)
      );
    }
    function v(t, e) {
      ...
      return (
        60 > o
          ...
          : ((i = Math.floor(o / 60)),
            (n = o % 60),
            30 == e && 30 == n && (i += T.decimal + 5),
            s.push(i),
            s.push(1 == i ? T.hr : T.hrs),
            30 != e && n && (s.push(n), s.push(T.mins))),
        s.join(" ")
      );
    }
    function y(e, i) {
      ...
      for (var a, l, u = "", c = 0; c < i.timeFormat.length; c++)
        switch ((l = i.timeFormat.charAt(c))) {
          case "a":
          ...
          case "g":
            ...
            break;
          case "G":
            (a = r.getHours()), e === x && (a = i.show2400 ? 24 : 0), (u += a);
            break;
          case "h":
    ...
    function w(t, e) {
      ...
      ("a" == (t = t.toLowerCase().replace(/[\s\.]/g, "")).slice(-1) ||
        "p" == t.slice(-1)) &&
        (t += "m");
      var i =
          "(" +
          ...
          ")?",
        n = new RegExp(
          "^" + i + "([0-9]?[0-9])\\W?([0-5][0-9])?\\W?([0-5][0-9])?" + i + "$"
        ),
        o = t.match(n);
      if (!o) return null;
    ...
    var x = 86400,
      ...
      C = {
        ...
        roundingFunction: function (t, e) {
          ...
          var i = t % (60 * e.step);
          return (
            (i -= (e.minTime || 0) % (60 * e.step)) >= 30 * e.step
              ? (t += 60 * e.step - i)
              : (t -= i),
            b(t, e)
          );
      ...
      _ = {
        init: function (e) {
          return this.each(function () {
            ...
            var a = t.extend({}, C, e, s);
            if (
              (a.lang && (T = t.extend(T, a.lang)),
              (a = i(a)),
              o.data("timepicker-settings", a),
              o.addClass("ui-timepicker-input"),
              a.useSelect)
            )
              n(o);
            else {
              if ((o.prop("autocomplete", "off"), a.showOn))
                for (var l in a.showOn)
                  o.on(a.showOn[l] + ".timepicker", _.show);
        ...
        show: function (i) {
          ...
          if ((i && i.preventDefault(), s.useSelect))
            o.data("timepicker-list").focus();
          else {
            a(o) && o.blur();
            var c = o.data("timepicker-list");
            if (
              !o.prop("readonly") &&
              ((c && 0 !== c.length && "function" != typeof s.durationTime) ||
                (n(o), (c = o.data("timepicker-list"))),
              !e(c))
            ) {
              ...
              s.orientation.match(/r/)
                ? (d.left =
                    ...
                    o.outerWidth() -
                    c.outerWidth() +
                    parseInt(c.css("marginLeft").replace("px", ""), 10))
                : (d.left =
                    o.offset().left +
                    parseInt(c.css("marginLeft").replace("px", ""), 10));
              "t" ==
              (s.orientation.match(/t/)
                ? "t"
                : s.orientation.match(/b/)
                ? "b"
                : o.offset().top + o.outerHeight(!0) + c.outerHeight() >
                  t(window).height() + t(window).scrollTop()
                ? "t"
                : "b")
                ? (c.addClass("ui-timepicker-positioned-top"),
                  (d.top =
                    o.offset().top -
                    c.outerHeight() +
                    parseInt(c.css("marginTop").replace("px", ""), 10)))
                : (c.removeClass("ui-timepicker-positioned-top"),
                  (d.top =
                    o.offset().top +
                    o.outerHeight() +
                    parseInt(c.css("marginTop").replace("px", ""), 10))),
              ...
              if (!p.length) {
                ...
                null !== f
                  ? (p = l(o, c, f))
                  : s.scrollDefault && (p = l(o, c, s.scrollDefault()));
              }
              if (
                ((!p.length || p.hasClass("ui-timepicker-disabled")) &&
                  (p = c.find("li:not(.ui-timepicker-disabled):first")),
                p && p.length)
              ) {
              ...
              return (
                ...
                s.closeOnWindowScroll &&
                  t(document).on("scroll.ui-timepicker", r),
        ...
        option: function (e, o) {
          return "string" == typeof e && void 0 === o
            ? t(this).data("timepicker-settings")[e]
            : this.each(function () {
                var s = t(this),
                ...
                "object" == typeof e
                  ? (r = t.extend(r, e))
                  : "string" == typeof e && (r[e] = o),
                  (r = i(r)),
                  s.data("timepicker-settings", r),
                  c.call(s.get(0), { type: "change" }, "initial"),
        ...
        setTime: function (t) {
          ...
          return (
            t && null === n && i.noneOption && (n = t),
            e.val(n),
            c.call(e.get(0), { type: "change" }, "initial"),
      ...
      return this.length
        ? _[e]
          ? this.hasClass("ui-timepicker-input")
            ...
            : this
          : "object" != typeof e && e
          ? void t.error("Method " + e + " does not exist on jQuery.timepicker")
    ...
    u.prototype = {
      ...
      _process_options: function (e) {
        ...
        var i = (this.o = t.extend({}, this._o)),
          n = i.language;
        switch (
          (f[n] || ((n = n.split("-")[0]), f[n] || (n = d.language)),
          (i.language = n),
          i.startView)
        ) {
          case 2:
        ...
        i.startDate !== -1 / 0 &&
          (i.startDate
            ? i.startDate instanceof Date
              ...
              : (i.startDate = m.parseDate(i.startDate, o, i.language))
            : (i.startDate = -1 / 0)),
          i.endDate !== 1 / 0 &&
            (i.endDate
              ? i.endDate instanceof Date
                ? (i.endDate = this._local_to_utc(this._zero_time(i.endDate)))
                : (i.endDate = m.parseDate(i.endDate, o, i.language))
              : (i.endDate = 1 / 0)),
      ...
      place: function () {
        if (!this.isInline) {
          ...
          this.picker.removeClass(
            ...
            "auto" !== this.o.orientation.x
              ? (this.picker.addClass(
                ...
                "right" === this.o.orientation.x && (h -= e - c))
          ...
          "auto" === m &&
            ...
            "top" === m
              ? (d += u)
              : (d -= i + parseInt(this.picker.css("padding-top"))),
            this.picker.css({ top: d, left: h, zIndex: r });
        }
      },
      _allow_update: !0,
      update: function () {
      ...
      fillDow: function () {
        ...
        for (; t < this.o.weekStart + 7; )
          e +=
            '<th class="dow">' + f[this.o.language].daysMin[t++ % 7] + "</th>";
      ...
      getClassNames: function (e) {
        ...
        return (
          e.getUTCFullYear() < n ||
          (e.getUTCFullYear() === n && e.getUTCMonth() < o)
            ? i.push("old")
            : (e.getUTCFullYear() > n ||
                (e.getUTCFullYear() === n && e.getUTCMonth() > o)) &&
              i.push("new"),
      ...
      fill: function () {
        ...
        this.picker
          ...
          .text(f[this.o.language].months[s] + " " + o),
          this.picker
            .find("tfoot th.today")
            .text(c)
        ...
        for (var v, y = []; d.valueOf() < g; ) {
          if (
            d.getUTCDay() === this.o.weekStart &&
            (y.push("<tr>"), this.o.calendarWeeks)
          ) {
            var w = new Date(
                +d + ((this.o.weekStart - d.getUTCDay() - 7) % 7) * 864e5
              ),
              b = new Date(Number(w) + ((11 - w.getUTCDay()) % 7) * 864e5),
              x = new Date(
                Number((x = i(b.getUTCFullYear(), 0, 1))) +
          ...
          if (
            ((v = this.getClassNames(d)).push("day"),
              ...
              r.is(".disabled") ||
                ...
                r.is(".month")
                  ? ((s = 1),
                    ...
                    this._trigger("changeMonth", this.viewDate),
                    1 === this.o.minViewMode && this._setDate(i(n, o, s)))
                  : ((s = 1),
                    (o = 0),
                    (n = parseInt(r.text(), 10) || 0),
                    this.viewDate.setUTCFullYear(n),
                    this._trigger("changeYear", this.viewDate),
                    2 === this.o.minViewMode && this._setDate(i(n, o, s))),
                this.showMode(-1),
                this.fill());
              break;
            case "td":
              r.is(".day") &&
                ...
                r.is(".old")
                  ? 0 === o
                    ? ((o = 11), (n -= 1))
                    : (o -= 1)
                  : r.is(".new") && (11 === o ? ((o = 0), (n += 1)) : (o += 1)),
                this._setDate(i(n, o, s)));
          }
        this.picker.is(":visible") &&
          this._focused_from &&
        ...
        if (this.picker.is(":not(:visible)")) 27 === t.keyCode && this.show();
          ...
          switch (t.keyCode) {
            ...
            case 39:
              ...
              (e = 37 === t.keyCode ? -1 : 1),
                t.ctrlKey
                  ? ((i = this.moveYear(this.dates.get(-1) || n(), e)),
                    (o = this.moveYear(r, e)),
                    this._trigger("changeYear", this.viewDate))
                  : t.shiftKey
                  ? ((i = this.moveMonth(this.dates.get(-1) || n(), e)),
                    (o = this.moveMonth(r, e)),
                    this._trigger("changeMonth", this.viewDate))
                  : ((i = new Date(this.dates.get(-1) || n())).setUTCDate(
                      i.getUTCDate() + e
                    ),
                    (o = new Date(r)).setUTCDate(r.getUTCDate() + e)),
              ...
              (e = 38 === t.keyCode ? -1 : 1),
                t.ctrlKey
                  ...
                  : ((i = new Date(this.dates.get(-1) || n())).setUTCDate(
                    ...
                    (o = new Date(r)).setUTCDate(r.getUTCDate() + 7 * e)),
                this.dateWithinRange(i) &&
                  ((this.focusDate = this.viewDate = o),
                  this.setValue(),
                  this.fill(),
        ...
        this.each(function () {
          ...
          if (!a) {
            ...
            if (o.is(".input-daterange") || f.inputs) {
              var m = { inputs: f.inputs || o.find("input").toArray() };
      ...
      m = {
        ...
        parseDate: function (e, n, o) {
          ...
          if (e) {
            ...
            if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(e)) {
              for (e = new Date(), l = 0; l < h.length; l++)
                switch (((r = c.exec(h[l])), (a = parseInt(r[1])), r[2])) {
                  case "d":
            ...
            (h = (e && e.match(this.nonpunctuation)) || []), (e = new Date());
            var d,
              p,
              g = {},
            ...
            if (
              ...
              for (l = 0, b = w.length; l < b; l++) {
                if (((d = parseInt(h[l], 10)), (r = w[l]), isNaN(d)))
                  switch (r) {
                    case "MM":
              ...
              for (l = 0; l < v.length; l++)
                (T = v[l]) in g &&
                  !isNaN(g[T]) &&
                  ((x = new Date(e)), y[T](x, g[T]), isNaN(x) || (e = x));
            }
            return e;
          }
        },
        formatDate: function (e, i, n) {
          ...
          (o.dd = (o.d < 10 ? "0" : "") + o.d),
            ...
            (e = []);
          for (
            var s = t.extend([], i.separators), r = 0, a = i.parts.length;
            r <= a;
            r++
          )
            s.length && e.push(s.shift()), e.push(o[i.parts[r]]);
          return e.join("");
        },
        headTemplate:
  ...
  (function (t, e) {
    ...
    return function (t, e, i, n) {
      ...
      o.detectFeatures(),
        o.features.oldIE &&
          (o.bind = function (t, e, i, n) {
            e = e.split(" ");
            for (
              var o, s = (n ? "detach" : "attach") + "Event", r = 0;
              r < e.length;
              r++
            )
              if ((o = e[r]))
      ...
      var a,
        ...
        Et = function (t) {
          (at = t), (s.bg.style.opacity = t * r.bgOpacity);
        },
        It = function (t, e, i, n, o) {
          (!xt || (o && o !== s.currItem)) &&
            (n /= o ? o.fitRatio : s.currItem.fitRatio),
          ...
          it &&
            (t &&
              (g > s.currItem.fitRatio
                ? xt || (ri(s.currItem, !1, !0), (xt = !0))
                : xt && (ri(s.currItem), (xt = !1))),
            It(it, dt.x, dt.y, g));
        },
        Ot = function (t) {
          t.container &&
        ...
        Nt = function (t, e) {
          if (!r.loop && e) {
            var i = c + (gt.x * ft - t) / gt.x,
              n = Math.round(t - fe.x);
            ((i < 0 && n > 0) || (i >= Xe() - 1 && n < 0)) &&
              (t = fe.x + n * r.mainScrollEndFriction);
          }
          (fe.x = t), Mt(t, h);
        },
        Lt = function (t, e) {
        ...
        qt = function (t) {
          return t || (t = s.currItem), t.w > 0 ? r.maxSpreadZoom : 1;
        },
        Ut = function (t, e, i, n) {
        ...
        te = function (t, e, i, n, o, s, r) {
          ...
          var u = function () {
            if (Xt[t]) {
              if ((a = Dt() - l) >= n) return Gt(t), s(i), void (r && r());
        ...
        ee = {
          ...
          init: function () {
            if (!a && !l) {
              ...
              for (
                ...
                Mt((i + d) * gt.x, T[i].el.style);
              $ || o.bind(s.scrollWrap, f, s),
                kt("initialZoomInEnd", function () {
          ...
          close: function () {
            a &&
              ...
              St("close"),
              jt(),
              Ge(s.currItem, null, !0, s.destroy));
          },
          destroy: function () {
            St("destroy"),
              Ue && clearTimeout(Ue),
          ...
          panTo: function (t, e, i) {
            i ||
              (t > et.min.x ? (t = et.min.x) : t < et.max.x && (t = et.max.x),
          ...
          invalidateCurrItems: function () {
            x = !0;
            for (var t = 0; t < 3; t++)
              T[t].item && (T[t].item.needsUpdate = !0);
          },
                ...
                for (var n = 0; n < i; n++)
                  vt > 0
                    ? ((e = T.shift()),
                      (T[2] = e),
                      d++,
                      Mt((d + 2) * gt.x, e.el.style),
                      s.setContent(e, c - i + n + 1 + 1))
                    : ((e = T.pop()),
                      T.unshift(e),
                      d--,
                      Mt(d * gt.x, e.el.style),
                      s.setContent(e, c + i - n - 1 - 1));
                if (it && 1 === Math.abs(vt)) {
                  var o = Qe(C);
                  o.initialZoomLevel !== g && (ii(o, pt), ri(o), Ot(o));
                }
                (vt = 0), s.updateCurrZoomItem(), (C = c), St("afterChange");
              }
            }
          },
          updateSize: function (e) {
            ...
            if (
              ((pt.x = s.scrollWrap.clientWidth),
              (pt.y = s.scrollWrap.clientHeight),
              Qt(),
              ...
              for (var n, a, l, u = 0; u < 3; u++)
                (n = T[u]),
                  ...
                  (l = c + u - 1),
                  r.loop && Xe() > 2 && (l = Ct(l)),
                  (a = Qe(l)) && (x || a.needsUpdate || !a.bounds)
                    ? (s.cleanSlide(a),
                      s.setContent(n, l),
                      1 === u && ((s.currItem = a), s.updateCurrZoomItem(!0)),
                      (a.needsUpdate = !1))
            ...
            (v = g = s.currItem.initialZoomLevel),
              (et = s.currItem.bounds) &&
                ((dt.x = et.center.x), (dt.y = et.center.y), At(!0)),
              St("resize");
          },
          zoomTo: function (t, e, i, n, s) {
            e &&
              ((v = g),
              (me.x = Math.abs(e.x) - dt.x),
              (me.y = Math.abs(e.y) - dt.y),
              $t(ht, dt));
            var r = Wt(t, !1),
              a = {};
            Ut("x", r, a, t), Ut("y", r, a, t);
            var l = g,
              u = { x: dt.x, y: dt.y };
            zt(a);
            var c = function (e) {
        ...
        ke = function (t, e) {
          return (
            (_e.prevent = !Ce(t.target, r.isClickableElement)),
        ...
        Ne = function (t) {
          ...
          return (
            I
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((Me[0] = Se(t.touches[0], Ae)),
                t.touches.length > 1 && (Me[1] = Se(t.touches[1], Oe)))
              : ((Ae.x = t.pageX),
                (Ae.y = t.pageY),
                (Ae.id = ""),
                (Me[0] = Ae)),
        ...
        Le = function (t, e) {
          var i,
            ...
            h = fe.x - le.x;
          return (
            (i = l > et.min[t] || l < et.max[t] ? r.panEndFriction : 1),
            (l = dt[t] + e[t] * i),
              ...
              ? "h" !== ot ||
                ...
                (u
                  ? (l > et.min[t] &&
                      ...
                      (n = et.min[t] - ht[t])),
                    (n <= 0 || h < 0) && Xe() > 1
                      ? ((a = c), h < 0 && c > le.x && (a = le.x))
                      : et.min.x !== et.max.x && (o = l))
                  : (l < et.max[t] &&
                      ((i = r.panEndFriction),
                      et.max[t],
                      (n = ht[t] - et.max[t])),
            ...
            "x" !== t)
              ? void (
                  nt ||
                  Z ||
                  (g > s.currItem.fitRatio && (dt[t] += e[t] * i))
                )
              : (void 0 !== a && (Nt(a, !0), (Z = a !== le.x)),
                et.min.x !== et.max.x &&
                  (void 0 !== o ? (dt.x = o) : Z || (dt.x += e.x * i)),
                void 0 !== a)
          );
        },
        $e = function (t) {
          if (!("mousedown" === t.type && t.button > 0)) {
            ...
            if (!U || "mousedown" !== t.type) {
              if ((ke(t, !0) && t.preventDefault(), St("pointerDown"), I)) {
                ...
                e < 0 && (e = ae.length),
                  (ae[e] = { x: t.pageX, y: t.pageY, id: t.pointerId });
              }
              var i = Ne(t),
                n = i.length;
              (G = null),
                ...
                !K &&
                  ...
                  $t(ne, i[1]),
                  De(ie, ne, ge),
                  (me.x = Math.abs(ge.x) - dt.x),
                  (me.y = Math.abs(ge.y) - dt.y),
                  (J = tt = we(ie, ne)));
            }
          }
        },
          ...
          if (G) {
            ...
            if (0 !== t)
              if (
                ...
                if (
                  ((se.x = ie.x), (se.y = ie.y), !oe.x && !oe.y && ve(G[1], ne))
                )
                  return;
                $t(ne, G[1]), V || ((V = !0), St("zoomGestureStarted"));
                var e = we(ie, ne),
                  i = He(e);
                i >
                  s.currItem.initialZoomLevel +
                    s.currItem.initialZoomLevel / 15 && (lt = !0);
                var n = 1,
                  o = Ht(),
                  a = qt();
                if (i < o)
                ...
                if (
                  (st &&
                    ((st = !1),
                    Math.abs(oe.x) >= 10 && (oe.x -= G[0].x - re.x),
                    Math.abs(oe.y) >= 10 && (oe.y -= G[0].y - re.y)),
                  (se.x = ie.x),
                  (se.y = ie.y),
                  0 === oe.x && 0 === oe.y)
                )
                ...
                if ("v" === ot && r.closeOnVerticalDrag && !Te()) {
                  (ct.y += oe.y), (dt.y += oe.y);
                  var u = Ie();
                  return (q = !0), St("onVerticalDrag", u), Et(u), void At();
                }
                Ee(Dt(), ie.x, ie.y),
                  (Q = !0),
                  (et = s.currItem.bounds),
        ...
        Re = function (t) {
          ...
          St("pointerUp"), ke(t, !1) && t.preventDefault();
          var e;
          if (I) {
            var i = o.arraySearch(ae, t.pointerId, "id");
            if (i > -1)
              if (((e = ae.splice(i, 1)[0]), navigator.pointerEnabled))
          ...
          if (
            ...
            if ((Jt(), W || (W = Fe()), W.calculateSwipeSpeed("x"), q))
              ...
              if (!nt)
                return "swipe" !== a
                  ? void qe()
                  : void (!Z && g > s.currItem.fitRatio && je(W));
            }
        },
        Fe = function () {
          var t,
            ...
            i = {
              ...
              calculateOverBoundsAnimOffset: function (t, e) {
                i.backAnimStarted[t] ||
                  (dt[t] > et.min[t]
                    ? (i.backAnimDestination[t] = et.min[t])
                    : dt[t] < et.max[t] &&
                      (i.backAnimDestination[t] = et.max[t]),
              ...
              panAnimLoop: function () {
                if (
                  Xt.zoomPan &&
                  ((Xt.zoomPan.raf = O(i.panAnimLoop)),
                  (i.now = Dt()),
          ...
          return (
            ...
            Math.abs(t.lastFlickSpeed.y) <= 0.05
              ? ((t.speedDecelerationRatioAbs.x = t.speedDecelerationRatioAbs.y = 0),
                ...
                !0)
              : (Kt("zoomPan"), (t.lastNow = Dt()), void t.panAnimLoop())
          );
        },
        We = function (t, e) {
          var i;
          ...
          if ("swipe" === t) {
            ...
            a > 30 && (l || e.lastFlickOffset.x > 20)
              ? (n = -1)
              : a < -30 && (l || e.lastFlickOffset.x < -20) && (n = 1);
          }
          var u;
          n &&
            ((c += n) < 0
              ? ((c = r.loop ? Xe() - 1 : 0), (u = !0))
              : c >= Xe() && ((c = r.loop ? 0 : Xe() - 1), (u = !0)),
            (u && !r.loop) || ((vt += n), (ft -= n), (i = !0)));
          var h,
            d = gt.x * ft,
            p = Math.abs(d - fe.x);
          return (
            i || d > fe.x == e.lastFlickSpeed.x > 0
              ? ((h =
            ...
            te("mainScroll", fe.x, d, h, o.easing.cubic.out, Nt, function () {
              Jt(),
                (nt = !1),
                (he = -1),
      ...
      var Ue,
        ...
        Ze,
        Ge = function (e, i, n, a) {
          Ue && clearTimeout(Ue), (Ve = !0), (Ye = !0);
          var l;
          e.initialLayout
            ? ((l = e.initialLayout), (e.initialLayout = null))
            : (l = r.getThumbBoundsFn && r.getThumbBoundsFn(c));
          ...
          !(function () {
            ...
            e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"),
              n ||
                ...
                (dt.x = l.x),
                (dt.y = l.y - L),
                (s[a ? "template" : "bg"].style.opacity = 0.001),
                At()),
              Kt("initialZoom"),
                ...
                function () {
                  if ((St("initialZoom" + (n ? "Out" : "In")), n)) {
                    var s = l.w / e.w,
                      ...
                      p = function (e) {
                        1 === e
                          ? ((g = s), (dt.x = l.x), (dt.y = l.y - z))
                          : ((g = (s - u) * e + u),
                            (dt.x = (l.x - r.x) * e + r.x),
                            (dt.y = (l.y - z - r.y) * e + r.y)),
                          At(),
                          a ? (t.style.opacity = 1 - e) : Et(c - e * c);
                      };
                    i
                      ? te("initialZoom", 0, 1, h, o.easing.cubic.out, p, d)
                      : (p(1), (Ue = setTimeout(d, h + 20)));
                  } else
                    (g = e.initialZoomLevel),
                      $t(dt, e.initialPosition),
                      At(),
          ...
          if (Je.length) {
            for (var t, e = 0; e < Je.length; e++)
              (t = Je[e]).holder.index === t.index &&
                ni(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
            Je = [];
          }
        };
      Tt("Controller", {
        publicMethods: {
          lazyLoadItem: function (t) {
            ...
            var e = Qe(t);
            e &&
              ((!e.loaded && !e.loading) || x) &&
              (St("gettingData", t, e), e.src && oi(e));
          },
            ...
            o.extend(r, ti, !0),
              ...
              kt("destroy", function () {
                for (var t, e = 0; e < Be.length; e++)
                  (t = Be[e]).container && (t.container = null),
      ...
      Tt("Tap", {
        publicMethods: {
          ...
          onTapRelease: function (t, e) {
            if (e && !Q && !Y && !Zt) {
              var i = e;
              if (li && (clearTimeout(li), (li = null), ye(i, ui)))
        ...
        publicMethods: {
          ...
          setupDesktopZoom: function (e) {
            ...
            var n,
              r = function () {
                s.mouseZoomedIn &&
                  (o.removeClass(t, "pswp--zoomed-in"), (s.mouseZoomedIn = !1)),
                  g < 1
          ...
          handleMouseWheel: function (t) {
            if (g <= s.currItem.fitRatio)
              return (
                r.modal &&
                  (!r.closeOnScroll || Zt || B
                    ? t.preventDefault()
                    : E && Math.abs(t.deltaY) > 2 && ((u = !0), s.close())),
                !0
              );
            if ((t.stopPropagation(), (hi.x = 0), "deltaX" in t))
              1 === t.deltaMode
                ? ((hi.x = 18 * t.deltaX), (hi.y = 18 * t.deltaY))
                : ((hi.x = t.deltaX), (hi.y = t.deltaY));
            else if ("wheelDelta" in t)
              t.wheelDeltaX && (hi.x = -0.16 * t.wheelDeltaX),
                t.wheelDeltaY
                  ? (hi.y = -0.16 * t.wheelDeltaY)
                  : (hi.y = -0.16 * t.wheelDelta);
            else {
      ...
      Tt("History", {
        publicMethods: {
          initHistory: function () {
            if ((o.extend(r, _i, !0), r.history)) {
              (Ti = window.location),
                ...
                yi.indexOf("gid=") > -1 &&
                  ((yi = yi.split("&gid=")[0]), (yi = yi.split("?gid=")[0])),
          ...
          onHashChange: function () {
            return ki() === yi
              ? ((bi = !0), void s.close())
              : void (mi || ((gi = !0), s.goTo(Di().pid), (gi = !1)));
          },
          updateURL: function () {
            Si(), gi || (wi ? (di = setTimeout(Ei, 800)) : Ei());
          },
        },
      }),
        o.extend(s, ee);
  ...
  (function (t, e) {
    ...
    return function (t, e) {
      var i,
        ...
        N = function () {
          for (var t, e, i, n, o, s = "", r = 0; r < g.shareButtons.length; r++)
            (t = g.shareButtons[r]),
        ...
        q = function () {
          h("onVerticalDrag", function (t) {
            C && t < 0.95
              ? x.hideControls()
              : !C && t >= 0.95 && x.showControls();
          });
          var t;
          h("onPinchClose", function (e) {
            C && e < 0.9
              ? (x.hideControls(), (t = !0))
              : t && !C && e > 0.9 && x.showControls();
          }),
      ...
      (x.init = function () {
        e.extend(t.options, k, !0),
          ...
          h("destroy", function () {
            g.captionEl &&
              (s && n.removeChild(s), e.removeClass(o, "pswp__caption--empty")),
          ...
          C && t.currItem
            ? (x.updateIndexIndicator(),
              g.captionEl &&
                ...
                E(o, "caption--empty", !t.currItem.title)),
              (T = !0))
            : (T = !1),
            _ || O(),
            I();
          ...
          if (!v)
            if (i.detail && "mouse" === i.detail.pointerType) {
              ...
              (g.tapToToggleControls &&
                (C ? x.hideControls() : x.showControls()),
              g.tapToClose && (e.hasClass(n, "pswp__img") || L(n)))
            )
              return void t.close();
        }),
  ...
  (function (t, e, i, n) {
    ...
    (d = {
      ...
      (o.prototype.onDragStart = function (n) {
        var o, r, a, l;
        if (
          3 === (o = n.originalEvent || n || e.event).which ||
          this.state.isTouch
        )
          return !1;
        if (
            ...
            this.settings.loop
              ...
              : ((a = this.coordinates(
                ...
                (this.drag.currentX = Math.max(
                  Math.min(this.drag.currentX, a + u),
                  l + u
                ))),
      ...
      (o.prototype.onDragEnd = function (e) {
        ...
        if (this.state.isTouch) {
          ...
          (this.drag.endTime = new Date().getTime()),
            ...
            (Math.abs(this.drag.distance) > 3 || n > 300) &&
        ...
        if (!s.loop && s.center) e = this._items.length - 1;
          ...
          if (s.loop || s.center) e = this._items.length + s.items;
            ...
            for (
              ...
              (n = this.coordinates(o)) && !(n * revert >= i);
      ...
      (o.prototype.to = function (i, n) {
        if (this.settings.loop) {
          ...
          a < this.settings.items && !1 === l
            ? ((s = r + this._items.length), this.reset(s))
            : a >= u - this.settings.items &&
              !0 === l &&
              ((s = r - this._items.length), this.reset(s)),
      ...
      (e.prototype.update = function () {
        ...
        if (
          ...
          for (this._pages = [], t = o, e = 0, i = 0; s > t; t++)
            (e >= r || 0 === e) &&
              (this._pages.push({ start: t - o, end: t - o + r - 1 }),
              (e = 0),
              ++i),
    ...
    (t.fn.tooltip = function (i) {
      return this.each(function () {
        ...
        (!o && /destroy|hide/.test(i)) ||
          (o || n.data("bs.tooltip", (o = new e(this, s))),
          "string" == typeof i && o[i]());
      });
    }),
    ...
    (t.fn.popover = function (i) {
      return this.each(function () {
        var n = t(this),
          ...
          s = "object" == typeof i && i;
        (!o && /destroy|hide/.test(i)) ||
          (o || n.data("bs.popover", (o = new e(this, s))),
          "string" == typeof i && o[i]());
      });
    }),
        ...
        for (var i in e) {
          ...
          for (var s in this.waypoints[i]) {
            var r = this.waypoints[i][s],
              ...
              u = a && l,
              c = !a && !l;
            (u || c) && (r.queueTrigger(o), (t[r.group.id] = r.group));
          }
        }
